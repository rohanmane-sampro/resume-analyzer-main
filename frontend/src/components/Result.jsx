...
const Result = () => {
  ...
  const renderSelectedTemplate = () => {
    ...
    const templateNumber = parseInt(selectedTemplate) || 1;
    const TemplateComponent = templateMap[templateNumber] || T1;
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full bg-gray-100 dark:bg-slate-800 px-4 py-8 transition-colors duration-300">
      ...
      <div
        id="capture-content"
        className={`text-left transition-all duration-300 bg-white shadow-2xl ${status === 'completed' ? 'relative visible' : 'absolute invisible'}`}
        style={{ width: '210mm', maxWidth: '95%' }}
      >
