...
const PricingModal = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            {/* Modal Content */}
            <div className="relative bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-5xl overflow-hidden animate-in fade-in zoom-in duration-300">

                {/* Header */}
                <div className="p-8 text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white relative">
                    <button
                        onClick={onClose}
                    ...
                    <h2 className="text-3xl font-bold mb-2">Upgrade Your Career 🚀</h2>
                    <p className="text-blue-100 max-w-xl mx-auto">Unlock premium templates and AI features to land your dream job faster.</p>
                </div>
