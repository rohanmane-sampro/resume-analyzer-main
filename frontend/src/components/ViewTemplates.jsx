...
export default function ViewTemplates() {
  ...
  const items = [
    ...
    },
    {
      ...
      title: titles[15],
      codeLink: "#/template/9",
      templateLink: "#/template/9",
    },
    {
      img: `${import.meta.env.BASE_URL}Temp/cv16.png`,
      title: titles[16],
      codeLink: "#/template/10",
      templateLink: "#/template/10",
    },
    {
      img: `${import.meta.env.BASE_URL}Temp/cv17.png`,
      title: titles[17],
      codeLink: "#/template/11",
      templateLink: "#/template/11",
    },
    {
      img: `${import.meta.env.BASE_URL}Temp/cv18.png`,
      title: titles[18],
      codeLink: "#/template/12",
      templateLink: "#/template/12",
    },
    {
