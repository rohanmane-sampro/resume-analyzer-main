...
import { T1Css, T2Css, T3Css, T4Css, T5Css, T6Css, T7Css, T9Css, T10Css, T11Css, T12Css, T13Css, T14Css, T15Css, T16Css, T17Css, T18Css, T19Css, T20Css, T21Css, T22Css, T23Css, T24Css, T25Css, T26Css, T27Css, T28Css, T29Css, T30Css, T31Css, T32Css } from './Templates';
  ...
  const generateActualTemplateHTML = () => {
    ...
    const getTemplateCss = () => {
      const templateCssMap = {
        ...
        '25': T25Css, '26': T26Css, '27': T27Css, '28': T28Css, '29': T29Css, '30': T30Css, '31': T31Css, '32': T32Css
      };
